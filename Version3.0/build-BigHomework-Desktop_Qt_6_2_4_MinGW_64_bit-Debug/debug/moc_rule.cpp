...
#define QT_MOC_LITERAL(ofs, len) \
    uint(offsetof(qt_meta_stringdata_rule_t, stringdata0) + ofs), len 
static const qt_meta_stringdata_rule_t qt_meta_stringdata_rule = {
    {
QT_MOC_LITERAL(0, 4) // "rule"
...
const QMetaObject rule::staticMetaObject = { {
    ...
    qt_meta_stringdata_rule.offsetsAndSize,
    qt_meta_data_rule,
    qt_static_metacall,
    nullptr,
qt_incomplete_metaTypeArray<qt_meta_stringdata_rule_t
, QtPrivate::TypeAndForceComplete<rule, std::true_type>
