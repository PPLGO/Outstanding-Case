...
public:
    ...
    void setupUi(QWidget *Widget)
    {
        ...
        layoutWidget->setGeometry(QRect(0, 100, 856, 82));
        ...
        layoutWidget1->setGeometry(QRect(1, 221, 856, 82));
        horizontalLayout = new QHBoxLayout(layoutWidget1);
        horizontalLayout->setObjectName(QString::fromUtf8("horizontalLayout"));
        horizontalLayout->setContentsMargins(0, 0, 0, 0);
        Minion0 = new QPushButton(layoutWidget1);
        ...
        Minion1 = new QPushButton(layoutWidget1);
        ...
        Minion2 = new QPushButton(layoutWidget1);
        ...
        Minion3 = new QPushButton(layoutWidget1);
        ...
        Minion4 = new QPushButton(layoutWidget1);
        ...
        Minion5 = new QPushButton(layoutWidget1);
        ...
        Minion6 = new QPushButton(layoutWidget1);
        ...
        Minion7 = new QPushButton(layoutWidget1);
        ...
        Minion8 = new QPushButton(layoutWidget1);
        ...
        Minion9 = new QPushButton(layoutWidget1);
...
"image: url(:/photo/Nahida3.jpg);"));
        ...
        HP->setGeometry(QRect(480, 490, 31, 31));
    ...
    void retranslateUi(QWidget *Widget)
    {
        ...
        Release->setText(QCoreApplication::translate("Widget", "Release", nullptr));
