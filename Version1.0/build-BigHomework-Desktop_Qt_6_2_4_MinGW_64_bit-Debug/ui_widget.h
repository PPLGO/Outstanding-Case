...
public:
    ...
    void setupUi(QWidget *Widget)
    {
        ...
        widget->setObjectName(QString::fromUtf8("widget"));
        widget->setGeometry(QRect(1, 221, 856, 82));
        horizontalLayout = new QHBoxLayout(widget);
        horizontalLayout->setObjectName(QString::fromUtf8("horizontalLayout"));
        horizontalLayout->setContentsMargins(0, 0, 0, 0);
        Minion0 = new QPushButton(widget);
        ...
        Minion1 = new QPushButton(widget);
        ...
        Minion2 = new QPushButton(widget);
        ...
        Minion3 = new QPushButton(widget);
        ...
        Minion4 = new QPushButton(widget);
        ...
        Minion5 = new QPushButton(widget);
        ...
        Minion6 = new QPushButton(widget);
        ...
        Minion7 = new QPushButton(widget);
        ...
        Minion8 = new QPushButton(widget);
        ...
        Minion9 = new QPushButton(widget);
    ...
    void retranslateUi(QWidget *Widget)
    {
        ...
        CheckMate->setText(QCoreApplication::translate("Widget", "PushButton", nullptr));
